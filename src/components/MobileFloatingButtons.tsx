...
const MobileFloatingButtons = () => {
    const phoneNumber = "+918708522231";
    const whatsappNumber = "+918813887813";
    ...
    return (
        <div className="fixed bottom-6 right-4 flex flex-col gap-3 z-50 md:hidden">
            ...
            <a
                ...
                className="flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
                aria-label="Call us"
            >
