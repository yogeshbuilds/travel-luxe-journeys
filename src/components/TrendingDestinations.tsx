        ...
        <div className="flex gap-6 overflow-x-auto pb-4 scrollbar-hide">
          {destinations.map((destination) => (
            <Card
              ...
              className="min-w-[300px] cursor-pointer overflow-hidden group hover:shadow-strong transition-all"
            >
              <div className="relative h-[400px]">
                ...
                <h3 className="absolute bottom-4 left-4 text-3xl font-serif font-bold text-background">
                  {destination.name}
                </h3>
              </div>
            </Card>
